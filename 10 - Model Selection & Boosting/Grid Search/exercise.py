...
# Import Data
dataset = pd.read_csv(r"10 - Model Selection & Boosting\Datasources\social_newtorks_ads_data.csv")
...
# Trainning the Kernel SVM model into the whole dataset 
...
print("Accuracy: {:.2f} %".format(accuracies.mean()*100)) # Average accuracy 90%
print("Standard Deviation: {:.2f} %".format(accuracies.std()*100)) # Low variance 4.8% :)
