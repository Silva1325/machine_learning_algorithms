...
# Import Data
dataset = pd.read_csv(r"3 - Classification\Datasources\social_newtorks_ads_data.csv")
...
plt.title('Random Decision Tree (Training set)')
plt.xlabel('Age')
...
plt.title('Random Decision Tree (Test set)')
plt.xlabel('Age')
plt.ylabel('Estimated Salary')
plt.legend()
plt.show()